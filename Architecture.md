...
- Current: `public/icons/app-icon.png` (256×256 master PNG, single source), SVG favicon + PWA icons (192/512/maskable)
- Target: `.ico` file for Windows (multiple sizes: 16, 20, 24, 32, 40, 48, 64, 96, 128, 256)
- Used in: installer, Start Menu, Desktop shortcut, title bar, taskbar (AppUserModelId `com.fileforge.app`)
- `build/icon.ico` generated by `scripts/generate-icons.mjs` (10 sizes: 16–256)
